...
const PromptCard = ({post,handleTagclick,handleEdit,handleDelete,tag}) => {
    ...
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        ...
        <Image
          ...
          />
          <div className="flex flex-col"><h3 className="font-satoshi font-semibold text-gray-900">{post.creator.username}</h3>
          <p className="font-inter text-sm text-gray-500">{post.creator.email
          }</p></div>
